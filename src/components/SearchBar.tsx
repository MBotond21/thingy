    ...
    return <>
        <div className="search-cont w-2/5 md:w-1/4">
            <div>
                ...
                <div className="group">
                    <input type="text" id="term" placeholder="Search" className="w-full relative z-20" onChange={(e) => setTerm(e.target.value)} />
                    <div className=" hidden group-focus-within:flex flex-col bg-111 absolute z-10 inset-y-10 w-2/5 md:w-1/4 h-fit max-h-72 rounded-b-lg shadow-md transition-all text-white overflow-scroll p-4">
                        {
